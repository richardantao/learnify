...
exports.create = (req, res) => {
    ...
    async.waterfall([ matchTerm, createClass ], (err, results) => {
        if(err) {
            return res.status(500).json({ message: err.message });
        } else {
...
exports.edit = (req, res) => {
    ...
    async.waterfall([ getClass, fetchCourseOptions ], (err, results) => {
        if(err) {
            return res.status(500).json({ message: err.message });
        } else {
...
exports.update = (req, res) => {
    ...
    async.waterfall([ matchTerm, updateClass ], (err, results) => {
        if(err) {
            return res.status(500).json({ message: err.message });
        } else {
            return res.status(200).json(results);
