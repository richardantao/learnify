...
export default ({ 
    ...
    return (
        <Col>
            {error ? <Snackbar header="" body="" footer="" /> : null}
            <Row>
            ...
            <Row id="dashboard-columns" className="body">
                <Col id="classes" className="classes-list">
                    <List 
                        needHeader={false}
                ...
                <Col id="tasks" className="tasks-list">
                    <List 
                        needHeader={false}
                ...
                <Col id="assessments" className="assessments-list">
                    <List 
                        needHeader={false}
