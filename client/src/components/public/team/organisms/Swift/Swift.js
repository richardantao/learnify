...
import { postSwift } from "../../../../actions/team/applications";
...
class Swift extends Component {
    ...
    static propTypes = {
        ...
        postSwift: PropTypes.func.isRequired,
...
const mapDispatchToProps = { postSwift, clearErrors };
